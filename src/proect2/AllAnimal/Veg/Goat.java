...
public class Goat extends Vegan {
    ...
    private final double satietyMax=10;
    private final int hungerMax=5;

    public Goat(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Goat(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
