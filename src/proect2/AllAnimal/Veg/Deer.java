...
// Олень
public class Deer extends Vegan {
    ...
    private final double satietyMax=26;
    private final int hungerMax=4;

    public Deer(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Deer(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
