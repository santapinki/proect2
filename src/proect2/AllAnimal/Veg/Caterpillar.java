...
// Гусиница
public class Caterpillar extends Vegan {
    ...
    private final double satietyMax = 0.0025;
    private final int hungerMax = 1;


    public Caterpillar(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Caterpillar(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
