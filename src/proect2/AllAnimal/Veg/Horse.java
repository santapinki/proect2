...
public class Horse extends Vegan {
    ...
    private final double satietyMax=45;
    private final int hungerMax=5;

    public Horse(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Horse(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
