...
public class Sheep extends Vegan {
    ...
    public Sheep(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Sheep(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
