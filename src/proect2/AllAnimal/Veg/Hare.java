...
// Заяц
public class Hare extends Vegan {
    ...
    private final double satietyMax=0.45;
    private final int hungerMax=7;

    public Hare(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Hare(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
