...
//Хомяк
public class Hamster extends Vegan {
    ...
    private final double satietyMax=0.0075;
    private final int hungerMax=3;

    public Hamster(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Hamster(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
