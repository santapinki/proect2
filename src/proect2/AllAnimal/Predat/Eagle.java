...
public class Eagle extends Predator {
    ...
    public Eagle(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Eagle(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
    ...
    public void eat(Map<String, ArrayList<Animal>> animals,Grass grass) {
        ...
        String[] menu = { "snake",   "hare", "duck", "hamster","caterpillar"};
        int eatMaxProc = 0;
        double howManyEat = 0;
       ...
       //         System.out.println("Еда кончилась у Орла");
                break;
            }
