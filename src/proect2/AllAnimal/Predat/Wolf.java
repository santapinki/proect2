...
import proect2.AllAnimal.Veg.Caterpillar;
...
public class Wolf extends Predator {
    ...
    private final double satietyMax=8;
    private final int hungerMax=10;

    public Wolf(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Wolf(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
    ...
    public void eat(Map<String, ArrayList<Animal>> animals, Grass grass) {
        ...
        String[] menu = {"fox", "eagle", "snake", "cow", "horse", "kangaroo", "deer", "sheep", "goat", "hare", "duck", "hamster"};
        int eatMaxProc = 0;
        double howManyEat = 0;
       ...
       //         System.out.println("Еда кончилась у Волк");
                break;
            }
