...
public class Snake extends Predator {
    ...
    private final double satietyMax=0.3;
    private final int hungerMax=15;

    public Snake(int quantityInOneCell) {
        this.quantityInOneCell = quantityInOneCell;
    }

    public Snake(double weight, int quantityInOneCell, int speed, double satiety, int hunger) {
        this.weight = weight;
        this.quantityInOneCell = quantityInOneCell;
        this.speed = speed;
    ...
    public void eat(Map<String, ArrayList<Animal>> animals,Grass grass) {
        ...
        String[] menu = {  "hare", "duck", "hamster","caterpillar"};
        int eatMaxProc = 0;
        double howManyEat = 0;
        ...
        //        System.out.println("Еда кончилась у змеи");
                break;
            }
